    ...
    RegisterNetEvent('az_train:createDrugsTrainClient', function(index)
        ...
        Config.CallBack('az_train:havespawntrain', function(spawntrain)
            if spawntrain then
                ...
                temptraindrugs = CreateMissionTrain(0, Config.DrugTrain[index].coordstrain.x, Config.DrugTrain[index].coordstrain.y,
                                                    Config.DrugTrain[index].coordstrain.z, math.random(0, 100))
                ...
                for k, v in pairs(Config.DrugTrainCargaison) do
                    ...
                    caissedrug[k] = CreateObject(GetHashKey('v_ind_cf_boxes'), coordscaisse.x, coordscaisse.y, coordscaisse.z, true, false,
                                                 false)
                            ...
                            Config.CallBack('az_train:havespawnpnj', function(spawnpnj)
                                if spawnpnj then
                                    ...
                                    for x, w in pairs(Config.DrugTrain[index].security) do
                                        ...
                                        SecurityPed[x] = CreatePed(7, GetHashKey(w.ped), w.coordspnj.x, w.coordspnj.y, w.coordspnj.z - 1,
                                                                   math.random(0, 120), true, true)
