if Config.useEventTrain and (Config.FrameWork == "ESX" or Config.FrameWork == "QBCore") then
    ...
    RegisterNetEvent(
        "az_train:createDrugsTrainClient",
        function(index)
                ...
                function(spawntrain)
                    if spawntrain then
                        ...
                        temptraindrugs =
                            CreateMissionTrain(
                            0,
                            Config.DrugTrain[index].coordstrain.x,
                            Config.DrugTrain[index].coordstrain.y,
                            Config.DrugTrain[index].coordstrain.z,
                            math.random(0, 100)
                        )
    ...
    RegisterNetEvent(
        "az_train:removeDrugsTrainClient",
        function(index)
