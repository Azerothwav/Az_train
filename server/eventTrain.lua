if Config.useEventTrain and (Config.FrameWork == "ESX" or Config.FrameWork == "QBCore") then
                    ...
                    function()
                        while true do
                            ...
                            for k, v in pairs(Config.DrugTrain) do
                                if
                                    lastdrugtrain and tonumber(t.hour) == tonumber(v.delais.hoursstop) and
                                        tonumber(t.min) == tonumber(v.delais.minstop)
                                 then
                                    lastdrugtrain = nil
                                ...
                                if lastdrugtrain == nil then
                                    if
                                        tonumber(v.delais.hoursstart) == tonumber(t.hour) and
                                            tonumber(t.min) == tonumber(v.delais.minstart)
                                     then
    ...
    RegisterNetEvent(
        "az_train:removeTrainDrugsServer",
        function(index)
